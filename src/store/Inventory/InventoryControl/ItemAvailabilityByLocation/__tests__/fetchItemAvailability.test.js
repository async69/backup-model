...
describe("Fetch Item Availability", () => {
  ...
  test("should update state on success fetch", () => {
    ...
    expect(selectAvailableItems(resolveState(nextState))).toEqual(data.results);
  });
