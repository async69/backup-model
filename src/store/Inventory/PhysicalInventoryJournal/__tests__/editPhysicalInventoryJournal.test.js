import reducer, {
    initialState, resolveState, selectEditStatus, selectPhysicalInventoryJournals, successFetch,
...
describe('edit UOM', () => {
    ...
    test('should update state on success edit', () => {
        ...
        expect(selectPhysicalInventoryJournals(resolveState(nextState)))
            .toEqual([data])
    })
