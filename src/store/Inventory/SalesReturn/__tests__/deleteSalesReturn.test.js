import reducer, {
    initialState, resolveState, selectDeleteStatus, selectSalesReturns, successFetch,
    requestDelete, successDelete, failureDelete
} from "../index"
import customStatus from "../../../../config/customStatus"

describe('delete Sales Return', () => {
    ...
    test('should update state on success delete', () => {
        ...
        expect(selectSalesReturns(resolveState(nextState)))
            .toEqual([])
    })
