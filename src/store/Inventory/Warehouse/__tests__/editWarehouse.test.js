import reducer, {
    initialState, resolveState, selectEditStatus, selectWarehouse, successFetch,
...
describe('edit UOM', () => {
    ...
    test('should update state on success edit', () => {
        const UOMs = { results: [{ id: 1, name: 'Default' }] }
        ...
        expect(selectWarehouse(resolveState(nextState)))
            .toEqual([data])
    })
