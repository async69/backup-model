...
import PayrollProcess from "./PayRollProcess/PayrollProcess";
import PayrollRate from "./PayrollRate/PayrollRate";
import SalaryIncomeTax from "./SalaryIncomeTax/SalaryIncomeTax";
                  ...
                  <Row>
                    ...
                    >
                      <Typography className="mb-2">
                        {" "}
                        <strong> Employee ID No. </strong>: {employee.id}{" "}
                      </Typography>
                    </Col>
                    <Col
                      md={3}
                  ...
                  >
                    <div>
                      ...
                      <TabContent activeTab={activeTab}>
                        ...
                        <TabPane tabId="4">
                          <Row>
                            <Col>{<EmployeeSlip />}</Col>
                          </Row>
                        </TabPane>
                        {/* <TabPane tabId="6">
                          <Row>
                            <Col>
                              <PayrollRate employee={employee} />
                            </Col>
                          </Row>
                        </TabPane>
                        <TabPane tabId="7">
                          <Row>
                            <Col>
                              <SalaryIncomeTax employee={employee} />
                            </Col>
                          </Row>
                        </TabPane> */}
                      </TabContent>
