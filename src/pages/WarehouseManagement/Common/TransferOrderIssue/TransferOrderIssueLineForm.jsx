...
class TransferOrderIssueLineForm extends ReusabelForm {
  initialState = {
    data: {
      remaining_quantity: "",
      quantity_requested: "",
  ...
  doSubmit = async () => {
    try {
      this.props.onSubmit(this.state.data, "toi_lines");
      this.resetForm();
    } catch (error) {}
  };
  render() {
      ...
      <CardBody>
        <Form onSubmit={this.handleSubmit}>
          <Row>
            ...
            <Col md={2} sm={12} xs={12}>
              {this.renderInput("quantity_issued", "Quantity Issued", "number")}
            </Col>
            <Col md={2} sm={12} xs={12}>
...
export default TransferOrderIssueLineForm;
