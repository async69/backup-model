...
const TableHeader = () => (
  <View style={styles.tableHeaderContainer}>
    ...
    <Text style={styles.tableHeader}>Warehouse</Text>
    <Text style={styles.tableHeader}>Bin</Text>
    <Text style={styles.tableHeader}>UOM</Text>
    <Text style={styles.tableHeader}>Requested </Text>
    <Text style={styles.tableHeader}>Issued </Text>
    <Text style={styles.tableHeader}>Item Type</Text>
