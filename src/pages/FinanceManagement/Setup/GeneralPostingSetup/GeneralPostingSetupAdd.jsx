...
import { getLoading } from "../../../../store/GeneralSetup/Posting/GeneralBusinessPostingSetup/";

class GeneralPostingSetupAdd extends ParentForm {
  constructor(props) {
    super(props);
    this.initialState = {
      data: {
    ...
    const updatedState = {
      ...
      data: {
        ...
        partnerGroup: data.partner_group_detail.id
          ...
          : "",
        itemGroup: data.item_group_detail.id ? data.item_group_detail.id : "",
  ...
  render() {
    ...
    return (
      <Card className="border-0">
        <CardHeader className="border-0">New General Posting Setup</CardHeader>
        <CardBody>
...
export default connect(getLoading)(GeneralPostingSetupAdd);
